...
# -*- coding: utf-8 -*-
"""
Script to write the full IntelliGrade Practicum Report to markdown.
Run this once to generate the report file.
"""

output_path = r'D:\Projects\IntelliGrade\Materials\report\IntelliGrade_Practicum_Report.md'
...
print(f"Report written successfully: {output_path}")
