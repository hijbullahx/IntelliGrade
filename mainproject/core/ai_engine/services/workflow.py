...
class SubmissionWorkflow:
    ...
    ALLOWED_TRANSITIONS: Dict[str, list] = {
        ...
        Status.AI_EVALUATED: [Status.UNDER_REVIEW, Status.FINALIZED, Status.FAILED],
        Status.UNDER_REVIEW: [Status.FINALIZED, Status.AI_EVALUATED, Status.MAPPING_COMPLETE, Status.OCR_COMPLETE, Status.FAILED],
